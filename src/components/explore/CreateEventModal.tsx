...
const CreateEventModal: React.FC<CreateEventModalProps> = ({ isOpen, onClose, onSubmit, isLoading = false }) => {
  ...
  }, [title, description, eventDate, eventTime, location, onSubmit]);
        ...
        <div className="overflow-y-auto" style={{ maxHeight: 'calc(90vh - 100px)' }}>
          <form onSubmit={handleSubmit} className="p-3 space-y-3">
            ...
            <div className="space-y-1">
              <label htmlFor="event-title" className="block text-xs font-medium text-gray-700">Event Title *</label>
            ...
            {/* Event Description */}
            <div className="space-y-1">
              <label htmlFor="event-description" className="block text-xs font-medium text-gray-700">Description</label>
              <textarea
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
              <div className="space-y-1">
                <label htmlFor="event-date" className="block text-xs font-medium text-gray-700">Date *</label>
                <div className="relative group">
              ...
              <div className="space-y-1">
                <label htmlFor="event-time" className="block text-xs font-medium text-gray-700">Time *</label>
                <div className="relative group">
            ...
            {/* Location */}
            <div className="space-y-1">
              <label htmlFor="event-location" className="block text-xs font-medium text-gray-700">Location</label>
              <div className="relative group">
